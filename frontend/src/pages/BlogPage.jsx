...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070C18] text-slate-900 dark:text-white transition-colors duration-200">
      {/* Header Section */}
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 border-b border-slate-200 dark:border-slate-800/80 overflow-hidden">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 ${
                selectedCategory === 'all'
                  ...
                  : 'bg-white dark:bg-slate-900/90 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-800 shadow-sm'
              }`}
            >
              All Categories
            </button>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">Loading field articles...</p>
          </div>
        ) : error ? (
          ...
          <div className="max-w-xl mx-auto text-center py-20 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-8 sm:p-12 shadow-sm dark:shadow-xl">
              ...
              >
                ...
                <div className="relative h-52 w-full overflow-hidden bg-slate-100 dark:bg-slate-950">
                  {post.featured_image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-slate-100 dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-900 border-b border-slate-200 dark:border-slate-800">
                      <BookOpen className="w-12 h-12 text-slate-400 dark:text-slate-700 group-hover:text-orange-500/60 transition-colors" />
                    </div>
                  )}
                  {/* Category Pill */}
                  <div className="absolute top-4 left-4">
                    <span className="px-3 py-1 bg-white/90 dark:bg-slate-950/80 backdrop-blur-md border border-slate-200 dark:border-slate-800 text-orange-500 dark:text-orange-400 font-semibold text-xs rounded-full shadow-sm">
                ...
                <div className="flex-1 p-6 flex flex-col justify-between">
                  <div>
                    ...
                    {/* Title */}
                    <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-orange-500 transition-colors leading-snug">
